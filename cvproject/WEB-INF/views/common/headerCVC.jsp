...
<form action="${logoutUrl}" method="post" id="logoutForm">
	...
	<div align="center" style="margin-top: 2.5cm;">	
		<nav>
          ...
          <ul class="menu">
           <li><a href="<c:url value="/user/others/complaintUserPending"/>">Complaint Delay Report</a></li> 
            <li><a href="<c:url value="/user/others/coord"/>">Monthly Report</a></li>
         <%--  <li><a href="<c:url value="/user/others/cvodetail"/>">CVO Detail Report</a></li>
           <li><a href="<c:url value="/user/others/cvoactivity"/>">CVO Activity Report</a></li> --%>
           </ul>
           <ul class="menu1">
            <li><a
