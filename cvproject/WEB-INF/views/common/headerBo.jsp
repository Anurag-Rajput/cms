	...
	<div align="center" style="margin-top: 2.5cm;">	
		<nav>
          ...
          <ul class="menu">
            ...
            <li><a href="<c:url value="/user/impinbox"/>"><img width="20px" height="20px" src="<c:url value="/resources/user/images/imp.png"/>"/>Important</a></li>
            <li>Report<ul><li><a href="<c:url value="/user/bo/report"/>">Pending & Disposal(Section Wise)</a></li>
            <li><a href="<c:url value="/user/monthlyReport"/>">Monthly Report</a></li>
            <li><a href="<c:url value="/user/EndToEndTracking"/>">EndToEndTracking</a></li>
            <li><a href="<c:url value="/user/bo/cvoMonthlyReport"/>">CVO Monthly Report</a></li>
            ...
            <li><a href="<c:url value="/user/summarySheet"/>">Summary Sheet</a></li>
