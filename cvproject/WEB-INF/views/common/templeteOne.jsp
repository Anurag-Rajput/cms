...
function drawtableforSO(data)
{ 
	
	$('#searchtableIdforSO').show();
	$('#searchtableIdforOther').hide();
	/* document.getElementById("SearchTableforSO").style.display="table";
	document.getElementById("SearchTableforOther").style.display="none"; */
	if(data==""){
			
		var table=$("#SearchTableforSO").dataTable(
				{
	...
	/* alert(data.length);
	alert(data[0].complaint.split("/")[0]); */
...
function drawtableforOther(data)
{
	$('#searchtableIdforSO').hide();
	$('#searchtableIdforOther').show();
	/* document.getElementById("SearchTableforSO").style.display="none";
	document.getElementById("SearchTableforOther").style.display="table"; */
	if(data==""){
		var table=$("#SearchTableforOther").dataTable(
				{
	...
	function getComplain() {
		...
		var complainOrganization = document.getElementById("c_org").value;
		...
		if(complainNo!="NONE" && complainNo!=""){
			$.ajax({
				...
				success : function(data) {
					...
					if(data[0].rollType=='other')
					{
						drawtableforOther(data);
					}
					else
					{
						drawtableforSO(data);	
...
if(complainOrganization!="NONE" && complainOrganization!=""){
	
	$.ajax({
		url : "<c:url value='/user/getDetailsByOrganization'/>",
		type : "POST",
		data : {
			"complainOrganization" : complainOrganization
		},
		success : function(data) {
			drawtableforSO(data)
...
<div id="searchtableIdforSO" style="width: 2100px; height: 500px;">
	<table id="SearchTableforSO" class ="display" style="width: 100%" border="solid;" >
		<thead>
		</thead>

	</table>
</div>
<div id="searchtableIdforOther" style="width: 2100px; height: 500px;" >
	<table id="SearchTableforOther" class ="display" style="width: 100%" border="solid;" >
		<thead>
		</thead>
