...
function departmentalInquiry()
{
	...
	<c:url var="formUrl" value="/user/getdepartmentalInquiryReport"></c:url>
    $.ajax({
	url:"${formUrl}",
	type: "POST",
	data: dataStr,
	...
	success: function(data){
		...
		var table=$("#departmentalInquiryTable").dataTable(
				{
					...
					buttons : [
							{
								extend : 'print',
								text : 'Print',
								title : "Cases Pending For Departmental Inquiry",
...
<body>
<br>
<h3 align="center"><b>Cases Pending For Departmental Inquiry</b></h3>
<c:forEach items="${cvo}" var="complain">
...
<center><div style="width: 80%">
	<table id="departmentalInquiryTable" class ="display" style="width: 100%"  >
	</table>	
</div>
</center>
</body>
