		...
		success : function(response) {
			...
			if(response.flag==true){
				...
				window.location = url
					...
					var url='<c:url value="/user/rti/rti"/>';
					window.location = url
				}
				
				else if(response.accessId==9){
					var anchorValue='window.open("<c:url value="/user/allNotingDetails/rti"/>","nyWindow","width=600,Height=400,top=100,left=400");';
...
<section id="content">
  <div class="main">
    <div class="wrapper">
      ...
      <br></br>  
       <div style="width: 710px; color: navy; background-color: #f3f3f3; border: 2px solid #3a8aff; border-radius: 25px; height: 1540px; 
