...
function DevReportforIRAjax(index,fromDate,toDate)
{
	$.ajax({
		url :"<c:url value='/user/getTotalPendingIRDetailsbySection'/>",
		type : "POST",
		data : {
			"fromDate" : fromDate,
			"toDate" : toDate,
...
function pendingdetailsIR(jsonData)
{

	$('#totalpendingdetailedreportforIR').DataTable(
			{
...
<body>
	...
	<div id="totalpendingIRId">
		<table id="totalpendingdetailedreportforIR" class="display"  style="width: 100%">
