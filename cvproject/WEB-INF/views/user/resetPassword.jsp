...
<br />
<!--==============================content================================-->
<c:url var="myurl" value="/user/changedPassword"/>
         ...
         <br>
        	...
        	<div class="form-group">
             ...
             <div class="form-group" align="right">	
              ...
              <label><button type="reset" class="button-2" name="close1" onclick="clearAll();">Reset</button></label>
			 &nbsp; &nbsp;<div class="form-list" align="left">
              ...
              <label><button type="submit" id="save" class="button-2" onclick="crypt();"  name="save" value="save">Save</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
