...
function DevReportAjax(diaryStatus,section,fromDate,toDate)  {
	$.ajax({
		url :"<c:url value='/user/getTotalPendingDetailsbySection'/>",
		type : "POST",
		data : {
			"fromDate" : fromDate,
			"toDate" : toDate,
...
function pendingdetails(jsonData)
	{
	$('#totalpendingdetailedreport').empty();
		$('#totalpendingdetailedreport').DataTable(
						{
...
<body>
	<div id="totalpendingId">
		<table id="totalpendingdetailedreport" class="display"  style="width: 100%">
