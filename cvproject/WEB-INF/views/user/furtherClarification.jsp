...
function furtherClarification()
{
	...
	<c:url var="formUrl" value="/user/getfurtherClarificationReport"></c:url>
    $.ajax({
	url:"${formUrl}",
	type: "POST",
	data: dataStr,
	...
	success: function(data){
		...
		var table=$("#furtherClarificationTable").dataTable(
				{
					...
					"aoColumns" : [ 
						...
						"sTitle" : "Clarification Date",
						"mData" : "complaindate",
						"className" : "dt-left",

					},{

						"sTitle" : "Reference type",
						"mData" : "createdDate",
						"className" : "dt-left",
					...
					buttons : [
							{
								extend : 'print',
								text : 'Print',
								title : "Cases Pending For Further Clarifications",
							}
...
<body>
<br>
<h3 align="center"><b>Cases Pending For Further Clarifications</b></h3>
<c:forEach items="${cvo}" var="complain">
...
<center><div style="width: 80%">
	<table id="furtherClarificationTable" class ="display" style="width: 100%"  >
	</table>	
</div>
</center>
</body>
