...
/* 	alert(orgCode);
	...
	<c:url var="formUrl" value="/user/getsecondStageReport"></c:url>
    $.ajax({
	url:"${formUrl}",
	type: "POST",
	data: dataStr,
	...
	success: function(data){
		...
		var table=$("#secondStageTable").dataTable(
				{
					...
					buttons : [
							{
								extend : 'print',
								text : 'Print',
								title : "Second Stage Pending Implementation",
...
<body>
<h3 align="center"><b>Second Stage Pending Implementation</b></h3>
<c:forEach items="${cvo}" var="complain">
...
<center>
	...
	<select class="form-control"  id="advCode" onchange="secondStage();"  style="width:150px">
...
<center><div style="width: 80%">
	<table id="secondStageTable" class ="display" style="width: 100%"  >
	</table>	
</div>
</center>
</body>
