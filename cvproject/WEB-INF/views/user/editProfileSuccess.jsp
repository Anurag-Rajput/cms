...
<title>CVC</title>
<meta charset="utf-8">
<link rel="stylesheet" href="<c:url value="/resources/user/css/reset.css"/>" type="text/css" media="screen">
<link rel="stylesheet" href="<c:url value="/resources/user/css/style.css"/>" type="text/css" media="screen">
<link rel="stylesheet" href="<c:url value="/resources/user/css/layout.css"/>" type="text/css" media="screen">
...
<header>
 <div>
 <img src="<c:url value="/resources/user/images/cvc_logo1.PNG"/>" alt="Smiley face" width="120" height="120" align="left">
...
<div align="center">
<img src="<c:url value="/resources/user/images/dholler-ok.png"/>" align="middle" width="70" height="70">
 <h3>You have Edited Profile Successfully... </h3></br>
 <%-- To login again <a href="<c:url value="/"/>">click here</a> --%>
