...
Date:  <b>${getAck.boDecisionDate}</b><%-- <b> &nbsp;${getAck.boDecisionDate.split("-")[2]}-${getAck.boDecisionDate.split("-")[1]}-${getAck.boDecisionDate.split("-")[0]}</b> --%>
...
<br><br>
<div align="left">
  A copy of the complaint dated: <b>${getAck.complainDate}</b> <%-- <b>${getAck.complainDate.split("-")[2]}-${getAck.complainDate.split("-")[1]}-${getAck.complainDate.split("-")[0]}</b> --%>, as received in the Commission, is sent herewith for necessary action. 
</div>
