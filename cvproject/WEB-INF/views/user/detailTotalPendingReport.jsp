...
function DevReportforTotalPendingCountAjax(fromDate,toDate)
{
	
	$.ajax({
		url :"<c:url value='/user/getTotalPendingAllVig'/>",
		type : "POST",
		data : {
			"fromDate" : fromDate,
			"toDate" : toDate
			...
			$('#totalpendingAllVig').DataTable(
					{
						...
						buttons : [ 
						{
				            extend: 'print',
				            text: 'Print',
				            title : "Total Pending All Vigiliance",
...
<body>
	...
	<div id="totalpendingOrgId" class="display"  style="width: 100%" >
		<table id="totalpendingAllVig"  >
