...
<tr>
 ...
 <th><strong>Received From Employee</strong></th>
   <th><strong>Created Date</strong></th>
    ...
    <!-- <th><strong>Again Open</strong></th> -->
</thead>
...
<%--  <td align="center"  onclick="sessionUpdate('complainNumber_${complain.complainNo}','9');"><a href="#" style="text-decoration:none; color:red">OPEN</a></td> --%>
</tr>   
