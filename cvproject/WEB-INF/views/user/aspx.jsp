...
<script src="<c:url value="/resources/user/js/jquery-1.12.0.min.js"/>"></script>
				...
				<div class="col-middle">
					<div class="text-center text-center">
						...
						<div class="mid_center">
							<h3>Search</h3>
								<c:url var="myurl" value="/user/101292.do.aspx.php"/>
							<form name="myform" id="myform" method="post" action="${myurl}" >
								<div class="col-xs-12 form-group pull-right top_search">
									<div class="input-group">
										<input type="text" class="form-control" name="aspx" placeholder="Search for..."> <span class="input-group-btn">
