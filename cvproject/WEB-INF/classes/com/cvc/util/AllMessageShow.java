...
public class AllMessageShow implements java.io.Serializable {
	...
	public AllMessageShow(String message, Type type) {
		this.message = message;
		this.type = type;
		this.args = null;
	}
	
	public AllMessageShow(String message, Type type, Object... args) {
		this.message = message;
		this.type = type;
		this.args = args;
	}
